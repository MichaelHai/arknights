...
export const AllItems: Array<string> = [
  '双酮', '酮凝集', '酮凝集组', '酮阵列', '异铁碎片', '异铁', '异铁组', '异铁块', '代糖', '糖', '糖组', '糖聚块', '酯原料', '聚酸酯', '聚酸酯组', '聚酸酯块', '破损装置', '装置', '全新装置', '改量装置', '源岩', '固源岩', '固源岩组', '提纯源岩', 'RMA70-12', 'RMA70-24', '研磨石', '五水研磨石', '轻锰矿', '三水锰矿', '扭转醇', '白马醇', '聚合剂', '双极纳米片', 'D32钢'];
